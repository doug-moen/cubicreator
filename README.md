Cubicreator is a slicer designed for the Cubicon line of 3D printers.
Cubicreator uses a modified version of CuraEngine, which has a GPL licence.
Here is the May 23 2018 snapshot of the Cubicreator fork of CuraEngine.
